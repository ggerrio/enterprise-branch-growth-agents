...
from branch_growth_analyst.data_parser import parse_june_data
...
* **Action Strategy:**
  1. Propose a quota increase of **{8 - int(jun_staff)} new marketing staff** to headquarters to return operational capacity to full (8 people).
